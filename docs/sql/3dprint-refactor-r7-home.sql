...
SET home_data = JSON_SET(home_data,
  ...
  '$.value."1772508227561001".menuConfig.list[0].img', '/statics/system_images/nav-category.svg',
  ...
  '$.value."1772508227561001".menuConfig.list[1].img', '/statics/system_images/nav-print.svg',
  ...
  '$.value."1772508227561001".menuConfig.list[2].img', '/statics/system_images/nav-inquiry.svg',
  ...
  '$.value."1772508227561001".menuConfig.list[3].img', '/statics/system_images/nav-file.svg',
  ...
  '$.value."1772508227561001".menuConfig.list[4].img', '/statics/system_images/nav-guide.svg',
