...
VALUES
  ('3D打印自动收货', 'print_auto_receipt', '待取满N天自动完成', 3, 0, 0, 0, 1, 0, 0, 0, 0, UNIX_TIMESTAMP(), UNIX_TIMESTAMP(), 0, 1, 'app()->make(\app\services\printqueue\PrintQueueServices::class)->autoReceipt();', '每小时执行')
